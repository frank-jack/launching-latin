//
//  NumbersMatching.swift
//  LaunchingLatin
//
//  Created by Jack Frank on 6/30/22.
//

import SwiftUI
import ConfettiSwiftUI

struct NumbersMatching: View {
    ...
    var body: some View {
        ZStack {
            ...
            if begun {
                VStack {
                    if (matchesCorrect+matchesWrong) < ModelData().numbers.count {
                        Button("Submit Match") {
                                ...
                                VStack {
                                    ForEach(orderLatin, id: \.self) { i in
                                        ZStack {
                                            ...
                                            Button(ModelData().numbers[orderLatin[i]].latin) {
                                    ...
                                    ForEach(orderEnglish, id: \.self) { i in
                                        ZStack {
                                            ...
                                            Image("paper")
                                                .resizable()
                                                .frame(width: UIScreen.main.bounds.width*3/4.14, height: UIScreen.main.bounds.height*2/8.96)
                                            Button(ModelData().numbers[orderEnglish[i]].number) {
                        ...
                        VStack {
                            Text("Your Score was "+String(matchesCorrect)+"/"+String(ModelData().numbers.count))
...
struct NumbersMatching_Previews: PreviewProvider {
