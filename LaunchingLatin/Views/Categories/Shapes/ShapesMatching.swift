...
struct ShapesMatching: View {
    ...
    var body: some View {
        ZStack {
            ...
            if begun {
                VStack {
                    if (matchesCorrect+matchesWrong) < ModelData().shapes.count {
                        Button("Submit Match") {
                                ...
                                VStack {
                                    ForEach(orderLatin, id: \.self) { i in
                                        ZStack {
                                            ...
                                            Button(ModelData().shapes[orderLatin[i]].latin) {
                                    ...
                                    ForEach(orderEnglish, id: \.self) { i in
                                        ZStack {
                                            ...
                                            Image("paper")
                                                .resizable()
                                                .frame(width: UIScreen.main.bounds.width*3/4.14, height: UIScreen.main.bounds.height*2/8.96)
                                            Button(ModelData().shapes[orderEnglish[i]].english) {
                        ...
                        VStack {
                            Text("Your Score was "+String(matchesCorrect)+"/"+String(ModelData().shapes.count))
...
struct ShapesMatching_Previews: PreviewProvider {
