...
public class LLAPILlapiClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "LLAPILlapiClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:LLAPILlapiClient = {
        ...
        return LLAPILlapiClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = LLAPILlapiClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `LLAPILlapiClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> LLAPILlapiClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         LLAPILlapiClient.registerClient(withConfiguration: configuration, forKey: "USWest2LLAPILlapiClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = LLAPILlapiClient.client(forKey: "USWest2LLAPILlapiClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(LLAPILlapiClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> LLAPILlapiClient {
		objc_sync_enter(self)
		if let client: LLAPILlapiClient = _serviceClients.object(forKey: key) as? LLAPILlapiClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			LLAPILlapiClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! LLAPILlapiClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://7snhsr8dgc.execute-api.us-east-1.amazonaws.com/dev"
